...
int D1=5, O1=137, PR1=173, ED1=-183, ED2=180, ED3=62, ED4=10, ED5=13, RZ1=465, RZ2=300, FM1=2934,
FM2=343, FM3=308, NM1=14, NM2=45, NM3=374, PC1=214, PC2=59, PC3=428, FV1=231, FV2=232, FV3=131,
FV4=40, FV5=138, FV6=117, FV7=90, BS1=103, BS2=78, CH1=12, CH2=18, CH3=1114, QS1=467, QS2=335;
TUNE(SetRange(1,10), D1);
TUNE(O1, PR1, ED1, ED2, ED3, ED4, ED5, RZ1, RZ2, FM1, FM2, FM3, NM1, NM2, NM3, PC1, PC2,
PC3, FV1, FV2, FV3, FV4, FV5, FV6, FV7, BS1, BS2, CH1, CH2, CH3, QS1, QS2);

int DCSE=131072, DD=10588, DO=81, DCV1=182069, DCV2=26131;
auto DRange2 = [](int d){return std::pair<int, int>(d/4, d*3);};
TUNE(SetRange(DRange2), DCSE, DD, DO, DCV1, DCV2);
