...
Value Search::Worker::search(
  Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
       ...
       )
    {
      ...
      {
          cutNode = cutNode ||  (ttValue > beta  + 30 + 10*depth); // what was a faillow is suddenly a failhigh?
          cutNode = cutNode && !(ttValue < alpha - 30 - 10*depth); // what was a failhigh is suddenly a faillow?
      }
    }
