...
int a1=124, a2=42, a3=55, a4=311, a5=49, a6=9190, a7=208, a8=301, a9=16, a10=1303, a11=590, a12=293, a13=1398,

b1=10, b2=10891, b3=128, b4=96, b5=67, b6=1877,
...
h1=268, h2=74, h3=1225, h4=786, h5=1020, h6=182;
    ...
    while ((move = mp.next_move(moveCountPruning)) != Move::none())
    {
        ...
        if (!rootNode && pos.non_pawn_material(us) && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
        {
            ...
            if (capture || givesCheck)
            {
                ...
                // TUNE(d9); TUNE(SetRange(10,150), d8);
                int seeHist = std::clamp(captHist / d8, -d6 * depth, d9 * depth);
