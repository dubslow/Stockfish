...
int B1=202, B2=246, B3=86, B4=257, B5=149, B6=189;
int P1=5, P3=15695, P5=232, P6=113;
...
moves_loop:  // When in check, search starts here
    ...
    else if (prevSq != SQ_NONE)
    {
      ...
      else
      {
        ...
        thisThread->captureHistory[pos.piece_on(prevSq)][prevSq][pos.captured_piece()] << stat_bonus(depth) * bonus / 800;
      }
    }
