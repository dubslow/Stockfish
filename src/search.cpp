...
namespace {
  ...
  Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    bool givesCheck, improving, priorCapture, singularQuietLMR, ttSingular;
...
moves_loop: // When in check, search starts here
    ...
    value = bestValue;
    moveCountPruning = singularQuietLMR = ttSingular = false;
    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
      ...
      if (singularQuietLMR || (ttSingular && move != ttMove))
          r--;
