...
// of TTEntry. Each non-empty TTEntry contains information on exactly one position. The purpose is to de-conflict
// hash collisions, which gains a smidge of elo.
