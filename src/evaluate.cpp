...
int UC1=7, UC2=1760, EV1=1064, EV2=170, EV3=416, EV4=424, EV5=269, EV6=754, EV7=195, EV8=211;
TUNE(SetRange(1,16), UC1);
TUNE(UC2, EV2, EV3, EV4, EV5, EV6, EV7);
TUNE(SetRange(700,1400), EV1);
TUNE(SetRange(50,800), EV8);
...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > UC1 && abs(psq) > UC2);
  ...
  {
      int nnueComplexity;
      int scale = EV1 + EV2 * pos.non_pawn_material() / 8192;
      ...
      nnueComplexity = (  EV3 * nnueComplexity
                        + EV4 * abs(psq - nnue)
      ...
      optimism = optimism * (EV5 + nnueComplexity) / 256;
      v = (nnue * scale + optimism * (scale - EV6)) / 1024;
  }

  // Damp down the evaluation linearly when shuffling
  v = v * (EV7 - pos.rule50_count()) / EV8;
